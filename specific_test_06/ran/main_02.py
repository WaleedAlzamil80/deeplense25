...
from Dataset import NPYSuperResolutionDataset
...
class PairedTransform:
    def __init__(self, transform, save_dir="debug_images"):
    ...
    def __call__(self, img1, img2):
        ...
        img1_save_path = os.path.join(self.save_dir, "img1_debug.png")
        img2_save_path = os.path.join(self.save_dir, "img2_debug.png")
...
batch_size=256
train_dataset = NPYSuperResolutionDataset(train_files, dataset_root, train_transforms, train_transforms)
...
val_dataset = NPYSuperResolutionDataset(val_files, dataset_root, val_transforms, val_transforms)
...
print("visible patches: ", int(0.25*225))
